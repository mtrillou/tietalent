...
<html lang="fr">
  <head>
      <meta charset="utf-8"/>
      <title>{{ trans('faqpartner.pagetitle') }}</title>
...
<!-- /Chatra {/literal} -->
  ...
  -->
    <main id="faq">
      <h1 class="faq-title" style="color:white;font-size:2rem;">{{ trans('faqpartner.title') }}</h1>
      <div class="faq-container">
        <h2 class="faq-headline">{{ trans('faqpartner.subtitle_one') }}</h2>
        <ul class="faq-list">
          <li class="faq-element faq-element">
            <span class="faq-element__title mobilePointer">{{ trans('faqpartner.element_one_title') }}</span>
            <div class="faq-element__answer">
              <p>{{ trans('faqpartner.element_one_details_a') }}<b>{{ trans('faqpartner.element_one_details_b') }}</b> {{ trans('faqpartner.element_one_details_c') }}</p>
              <p>{{ trans('faqpartner.element_one_details_d') }}</p>
              <p>{{ trans('faqpartner.element_one_details_e') }}</p>
            </div>
          </li>
          <li class="faq-element">
            <span class="faq-element__title mobilePointer">{{ trans('faqpartner.element_two_title') }}</span>
            <div class="faq-element__answer">
              <p>{{ trans('faqpartner.element_two_details_a') }}</p>
            </div>
          </li>
        </ul>
        <h2 class="faq-headline">{{ trans('faqpartner.subtitle_two') }}</h2>
        <ul class="faq-list">
          <li class="faq-element">
            <span class="faq-element__title">{{ trans('faqpartner.element_five_title') }}</span>
            <div class="faq-element__answer">
              <p>{{ trans('faqpartner.element_five_details_a') }}</p>
            </div>
          </li>
          <li class="faq-element">
            <span class="faq-element__title">{{ trans('faqpartner.element_three_title') }}</span>
            <div class="faq-element__answer">
              <p>{{ trans('faqpartner.element_three_details_a') }}</p>
            </div>
          </li>
          <li class="faq-element faq-element">
            <span class="faq-element__title">{{ trans('faqpartner.element_four_title') }}</span>
            <div class="faq-element__answer">
              <p>{{ trans('faqpartner.element_four_details_a') }}</p>
            </div>
          </li>
        </ul>
      </div>
